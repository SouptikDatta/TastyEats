            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
              {
                serviceLists.map((service) => (
                  <div key={service.id} className="shadow-md rounded-lg py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:scale-110 hover:bg-violet-100 hover:text-black transition-all duration-200">
                      <img src={service.img} alt="" className="mx-auto animate-bounce"/>
